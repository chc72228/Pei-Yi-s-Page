...
$(document).ready(function() {
    ...
    imgMain = new Image();
    imgMain.src = "SimpleRPG/images/images/spriteSheet.png";
    currentImgMainX = 0;
    currentImgMainY = 0;
    imgMain.onload = function()
    {    
        ctx.drawImage(imgMain,0,0,80,130,currentImgMainX,currentImgMainY,
                      200,200);
    };
    
    //擺上障礙物與敵人
    imgMountain= new Image();
    imgMountain.src= "SimpleRPG/images/images/material.png";
    imgEnemy= new Image();
    imgEnemy.src= "SimpleRPG/images/images/Enemy.png";
